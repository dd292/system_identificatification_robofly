...
f_cont_d = @(t,xx)( f_ud(t,xx,uprbs(t+1)) );
...
for i = 1:Nsim
    ...
    % True dynamics
    x_true = [x_true, f_ud(0,x_true(:,end),uprbs(i)) ];
    
    % Koopman predictor
    xlift = [xlift Alift*xlift(:,end) + Blift*uprbs(i)];
    
end

figure
stairs([1:Nsim]*deltaT,uprbs(1:Nsim),'linewidth',2); hold on
