...
class GP:
    ...
    def __init__(self, delta_t= 1/100, traj_length=1, num_epoch= 7):
        ...
        self.kernel_length_scales =np.array([[1.9,  1.9,  1.9,  1.9,   1.9,   1.9, 250.,  250,  250],\
                                             [1.9, 1.9, 1.9, 1.9, 1.9, 1.9, 250., 250., 250.],\
                                             [1.9, 1.9, 1.9, 1.9, 1.9, 1.9, 250., 250., 250.],\
                                             [1.9, 1.9, 1.9, 1.9, 1.9, 1.9, 250., 250., 250.],\
                                             [1.9, 1.9, 1.9, 1.9, 1.9, 1.9, 250., 250., 250.],\
                                             [1.9, 1.9, 1.9, 1.9, 1.9, 1.9, 250., 250., 250.],\
        ...
        print(self.kernel_length_scales)
        self.kernel_scale_factors = np.ones((9,1))*0.1
